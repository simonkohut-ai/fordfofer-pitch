/**
 * 📱 BUFFER EXTENSION AUTO - Generuje posty a pripravuje pre Buffer extension
 * Ty len skopíruješ a klikneš Buffer extension
 */
...
╔═══════════════════════════════════════════════════════════════╝
║  📋 INŠTRUKCIE:
║  1. Skopíruj text vyššie
║  2. Klikni Buffer extension v prehliadači
║  3. Paste → Post
║  4. DONE!
║  💾 Súbor: ${filename}
╚═══════════════════════════════════════════════════════════════╝
`;
    ...
    try {
        ...
        exec(`echo ${JSON.stringify(content)} | clip`, (error) => {
            if (!error) {
...
async function runCycle() {
    console.log('\n' + '═'.repeat(60));
    console.log('🚀 BUFFER EXTENSION AUTO CYCLE');
    ...
    if (content) {
        ...
        console.log('✅ POST PRIPRAVENÝ PRE BUFFER EXTENSION!');
        console.log('📋 Text je v schránke - klikni Buffer extension a postni!\n');
    }
...
console.log(`
╔═══════════════════════════════════════════════════════════════╗
║     📱 BUFFER EXTENSION AUTO                                  ║
║     Generuje → Kopíruje → Ty len klikneš Buffer extension    ║
╠═══════════════════════════════════════════════════════════════╣
║                                                                 ║
